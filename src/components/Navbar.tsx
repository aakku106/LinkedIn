...
export default function Navbar() {
  return (
    <nav className=" sticky top-0 backdrop-blur-sm navBar flex justify-between bg-white/90 dark:bg-black/90 text-black dark:text-white text-nowrap items-center-safe " >
      ...
      <NavLink
        to={"/"}
        className="logo-container order-first flex flex-col items-center-safe hover:cursor-pointer hover:text-blue-700}">
      ...
      <div className="mainNaviagtions flex">
        <NavLink
          to={"/feed"}
          className={({ isActive }) => `home m-6 flex flex-col items-center-safe hover:cursor-pointer ${isActive ? "active" : "hover:text-blue-700"}`}>
        ...
        <NavLink
          to="/network"
          className={({ isActive }) => `network m-6 flex flex-col items-center-safe hover:cursor-pointer ${isActive ? "active" : "hover:text-blue-700"}`}>
        ...
        <NavLink to="/jobs" className={({ isActive }) => `jobs m-6 flex flex-col items-center-safe hover:cursor-pointer ${isActive ? "active" : "hover:text-blue-700"}`}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" className="mercado-match" width="24" height="24" focusable="false">
        ...
        <NavLink to="/messages" className={({ isActive }) => `message m-6 flex flex-col items-center-safe hover:cursor-pointer ${isActive ? "active" : "hover:text-blue-700"}`}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" className="mercado-match" width="24" height="24" focusable="false">
