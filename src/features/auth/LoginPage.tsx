      ...
      <nav className="p-1 bg-blue-700" >
        <div className="logo m-6 ">
          <svg
            ...
            <g className="inbug hover:text-blue-50" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            ...
            <g className="linkedin-text hover:text-blue-50">
      ...
      <section className="flex flex-col justify-between">
        ...
        <div className=" p-6 login-outer-container login-section flex flex-row flex-wrap justify-around bg-blue-50">
          <div className="login-sections  flex flex-col items-center justify-center-safe">
            ...
            <button className=" bg-blue-100 border text-center border-blue-950 min-w-96 p-4 m-6 rounded-full  hover:cursor-pointer hover:bg-blue-50" >
              <span>
                Sign in with email
              </span>
            </button>
